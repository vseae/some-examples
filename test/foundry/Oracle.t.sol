...
import {OUSD} from "../../contracts/security/OUSD.sol";
import {IUniswapV2Router02} from "./IUniswapV2Router02.sol";
import {IWETH} from "./IWETH.sol";
import {IBUSD} from "./IBUSD.sol";
...
contract OracleTest is Test {
    ...
    function testOracleAttack() public {
        ...
        (uint112 reserve0, uint112 reserve1) = ousd.getReserves();
        console.log("reserve0: %s, reserve1: %s", reserve0, reserve1);
        // 2. 用busd买weth，推高顺时价格
        vm.prank(alice);
        ...
        // 3. 操纵预言机之后的价格
        (reserve0, reserve1) = ousd.getReserves();
        console.log("reserve0: %s, reserve1: %s", reserve0, reserve1);
    ...
    function swapBUSDtoWETH(uint amountIn, uint amountOutMin) public returns (uint amountOut) {
        ...
        uint[] memory amounts = router.swapExactTokensForTokens(amountIn, amountOutMin, path, alice, block.timestamp);
