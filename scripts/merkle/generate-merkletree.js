    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 3:
          ...
          line = rl_1_1.value;
          values = line.split(",").map(function (value) {
        ...
        case 7:
          ...
          if (!(rl_1_1 && !rl_1_1.done && (_a = rl_1["return"])))
            return [3 /*break*/, 9];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          data = _a.sent();
          console.log(data);
          tree = merkle_tree_1.StandardMerkleTree.of(data, [
            "address",
            "uint256",
          ]);
          console.log("Merkle Root:", tree.root);
          fs.writeFileSync(
            "scripts/merkle/tree.json",
